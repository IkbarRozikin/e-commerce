...
func (p *productService) GetProductDetails(ctx context.Context, req *entity.GetProductDetailsByIdRequest) (entity.GetProductDetailsByIdResponse, error) {
	res, err := p.repo.GetProductDetailsById(ctx, req)
	if err != nil {
		return res, err
	}
