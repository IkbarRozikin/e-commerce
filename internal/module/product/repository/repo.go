...
func (p *productRepository) GetProductDetailsById(ctx context.Context, req *entity.GetProductDetailsByIdRequest) (entity.GetProductDetailsByIdResponse, error) {

	var res entity.GetProductDetailsByIdResponse
